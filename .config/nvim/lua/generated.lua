...
local c = {
  ...
  on_primary_fixed = '#3a071e',
  on_primary_fixed_variant = '#6f334a',
  on_secondary = '#422931',
  on_secondary_container = '#ffd9e3',
  on_secondary_fixed = '#2b151d',
  on_secondary_fixed_variant = '#5a3f48',
  on_surface = '#efdfe2',
  on_surface_variant = '#d5c2c6',
  on_tertiary = '#48290c',
  on_tertiary_container = '#ffdcc2',
  on_tertiary_fixed = '#2e1500',
  on_tertiary_fixed_variant = '#623f20',
  outline = '#9e8c90',
