...
local c = {
  ...
  inverse_primary = '#8e4d30',
  inverse_surface = '#f1dfd9',
  on_background = '#f1dfd9',
  on_error = '#690005',
  on_error_container = '#ffdad6',
  on_primary = '#552107',
  on_primary_container = '#ffdbcd',
  on_primary_fixed = '#360f00',
  on_primary_fixed_variant = '#71361b',
  on_secondary = '#442a1f',
  on_secondary_container = '#ffdbcd',
  on_secondary_fixed = '#2c160c',
  on_secondary_fixed_variant = '#5d4034',
  on_surface = '#f1dfd9',
  on_surface_variant = '#d8c2ba',
  on_tertiary = '#373106',
  on_tertiary_container = '#f0e3a8',
  on_tertiary_fixed = '#211c00',
  on_tertiary_fixed_variant = '#4f471b',
  outline = '#a08d86',
  outline_variant = '#53433e',
  primary = '#ffb597',
  primary_container = '#71361b',
  primary_fixed = '#ffdbcd',
  primary_fixed_dim = '#ffb597',
  scrim = '#000000',
  secondary = '#e7beae',
  secondary_container = '#5d4034',
  secondary_fixed = '#ffdbcd',
  secondary_fixed_dim = '#e7beae',
  shadow = '#000000',
  source_color = '#e17544',
  surface = '#1a110e',
  ...
  surface_container_highest = '#3d322e',
  ...
  tertiary = '#d3c78f',
  tertiary_container = '#4f471b',
  tertiary_fixed = '#f0e3a8',
  tertiary_fixed_dim = '#d3c78f',
}
