...
local c = {
  background = '#10140f',
  background_custom = '#a1d39a',
  background_custom_container = '#235024',
  background_custom_source = '#10140f',
  background_custom_value = '#10140f',
  error = '#ffb4ab',
  error_container = '#93000a',
  inverse_on_surface = '#2d322c',
  inverse_primary = '#3c6939',
  inverse_surface = '#e0e4db',
  on_background = '#e0e4db',
  on_background_custom = '#09390f',
  on_background_custom_container = '#bcf0b4',
  on_error = '#690005',
  on_error_container = '#ffdad6',
  on_primary = '#0b390f',
  on_primary_container = '#bdf0b4',
  on_primary_fixed = '#002203',
  on_primary_fixed_variant = '#245023',
  on_secondary = '#253423',
  on_secondary_container = '#d6e8ce',
  on_secondary_fixed = '#111f0f',
  on_secondary_fixed_variant = '#3b4b38',
  on_surface = '#e0e4db',
  on_surface_variant = '#c2c8bd',
  on_tertiary = '#00363b',
  on_tertiary_container = '#bcebf0',
  on_tertiary_fixed = '#002023',
  on_tertiary_fixed_variant = '#1e4d52',
  outline = '#8c9388',
  outline_variant = '#424940',
  primary = '#a1d399',
  primary_container = '#245023',
  primary_fixed = '#bdf0b4',
  primary_fixed_dim = '#a1d399',
  scrim = '#000000',
  secondary = '#baccb3',
  secondary_container = '#3b4b38',
  secondary_fixed = '#d6e8ce',
  secondary_fixed_dim = '#baccb3',
  shadow = '#000000',
  source_color = '#9fd597',
  surface = '#10140f',
  ...
  surface_dim = '#10140f',
  surface_tint = '#a1d399',
  surface_variant = '#424940',
  tertiary = '#a0cfd4',
  tertiary_container = '#1e4d52',
  tertiary_fixed = '#bcebf0',
  tertiary_fixed_dim = '#a0cfd4',
}
