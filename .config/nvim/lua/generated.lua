...
local c = {
  background = '#0f1512',
  background_custom = '#8bd5b5',
  background_custom_container = '#00513a',
  background_custom_source = '#0f1512',
  background_custom_value = '#0f1512',
  error = '#ffb4ab',
  error_container = '#93000a',
  inverse_on_surface = '#2c322f',
  inverse_primary = '#156b54',
  inverse_surface = '#dee4df',
  on_background = '#dee4df',
  on_background_custom = '#003827',
  on_background_custom_container = '#a7f2d0',
  on_error = '#690005',
  on_error_container = '#ffdad6',
  on_primary = '#00382a',
  on_primary_container = '#a4f2d5',
  on_primary_fixed = '#002117',
  on_primary_fixed_variant = '#00513e',
  on_secondary = '#1e352d',
  ...
  primary = '#88d6ba',
  primary_container = '#00513e',
  primary_fixed = '#a4f2d5',
  primary_fixed_dim = '#88d6ba',
  scrim = '#000000',
  secondary = '#b2ccc1',
