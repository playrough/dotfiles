...
local c = {
  background = '#121318',
  background_custom = '#e3b7f3',
  background_custom_container = '#5c396c',
  background_custom_source = '#161217',
  background_custom_value = '#161217',
  error = '#ffb4ab',
  ...
  on_background_custom = '#442254',
  on_background_custom_container = '#f7d8ff',
  on_error = '#690005',
