...
local c = {
  background = '#101418',
  background_custom = '#9fcafc',
  background_custom_container = '#174974',
  background_custom_source = '#111418',
  background_custom_value = '#111418',
  error = '#ffb4ab',
  error_container = '#93000a',
  inverse_on_surface = '#2d3135',
  inverse_primary = '#2d628c',
  inverse_surface = '#e0e2e8',
  on_background = '#e0e2e8',
  on_background_custom = '#003257',
  on_background_custom_container = '#d0e4ff',
  on_error = '#690005',
