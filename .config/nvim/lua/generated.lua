...
local c = {
  background = '#11140f',
  background_custom = '#a8d293',
  background_custom_container = '#2b4f1e',
  background_custom_source = '#11140f',
  background_custom_value = '#11140f',
  error = '#ffb4ab',
  ...
  on_background_custom = '#153809',
  on_background_custom_container = '#c3efad',
  on_error = '#690005',
  on_error_container = '#ffdad6',
  on_primary = '#173807',
  on_primary_container = '#c5efab',
  on_primary_fixed = '#072100',
  on_primary_fixed_variant = '#2d4f1c',
  on_secondary = '#283420',
  on_secondary_container = '#d9e7cb',
  on_secondary_fixed = '#131f0d',
  on_secondary_fixed_variant = '#3e4a35',
  on_surface = '#e1e4d9',
  ...
  primary = '#a9d291',
  primary_container = '#2d4f1c',
  primary_fixed = '#c5efab',
  primary_fixed_dim = '#a9d291',
  scrim = '#000000',
  secondary = '#bdcbb0',
  secondary_container = '#3e4a35',
  secondary_fixed = '#d9e7cb',
