...
local c = {
  ...
  on_primary_fixed = '#001e31',
  on_primary_fixed_variant = '#044b71',
  on_secondary = '#22323f',
  on_secondary_container = '#d4e4f6',
  on_secondary_fixed = '#0d1d2a',
  on_secondary_fixed_variant = '#394856',
  on_surface = '#e0e3e8',
  on_surface_variant = '#c2c7ce',
  on_tertiary = '#372a4a',
  on_tertiary_container = '#ecdcff',
  on_tertiary_fixed = '#211534',
  on_tertiary_fixed_variant = '#4e4162',
  outline = '#8c9198',
  outline_variant = '#42474e',
  primary = '#98ccf9',
  primary_container = '#044b71',
